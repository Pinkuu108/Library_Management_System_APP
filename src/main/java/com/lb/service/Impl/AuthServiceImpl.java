...
import com.lb.configrations.JwtProvider;
import com.lb.domain.UserRole;
import com.lb.entity.PasswordResetToken;
import com.lb.entity.User;
import com.lb.genreRepository.PasswordResetTokenRepository;
...
public class AuthServiceImpl implements AuthService {
	...
	public AuthResponse signup(UserDTO req) throws UserException {
		...
		response.setMessage("Register Sucessfull");
	...
	public void createPasswordResetToken(String email) throws UserException {
		...
		String body = "You request to reset your password,Use this link (valid t minutes):";
     //sent email
